...
def run(
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path(data.get('path', '../coco')) / 'instances_visdrone.json')  # annotations json
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/myVisDrone.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='/home/dell/sfx/yolov9-main/runs/train/exp162/weights/best.pt', help='model path(s)')
