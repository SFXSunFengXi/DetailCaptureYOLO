...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='', help='initial weights path')   #  gelan-c_NewFPN_bifpn_lite.yaml
    parser.add_argument('--cfg', type=str, default='/home/dell/sfx/yolov9-main/models/detect/DetailCaptureYOLO.yaml', help='model.yaml path')
