...
from .conv import Conv, DWConv, RepConv, GhostConv, autopad, LightConv
from .block import BasicBlock, BottleNeck, RepC3, C3, C2f, Bottleneck
...
class DCNv2_Dynamic(nn.Module):
    ...
    def forward(self, x):
        ...
        # o1, o2, mask = self.conv_offset_mask(x)
    ...
    def reset_parameters(self):
        ...
        # self.conv_offset_mask.conv_offset.weight.data.zero_()
        # self.conv_offset_mask.conv_mask.weight.data.zero_()
        # self.conv_offset_mask.conv_offset.bias.data.zero_()
        # self.conv_offset_mask.conv_mask.bias.data.zero_()
